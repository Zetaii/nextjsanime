    ...
    extend: {
      ...
      keyframes: {
        ...
        "my-glow-combined": {
          ...
          "60%": { boxShadow: "0 0 50px 4px #48abe0" },
          "70%": { boxShadow: "0 0 50px 3px #48abe0" },
          "80%": { boxShadow: "0 0 50px 2px #48abe0" },
          "90%": { boxShadow: "0 0 50px 1px #48abe0" },
          "100%": { boxShadow: "0 0 50px 0px #48abe0" },
        },
        "my-glow": {
          "0%": { boxShadow: "0 0 50px 0px #48abe0" },
          "10%": { boxShadow: "0 0 50px 1px #48abe0" },
